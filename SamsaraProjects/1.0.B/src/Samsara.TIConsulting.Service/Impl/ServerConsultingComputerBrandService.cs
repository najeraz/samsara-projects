...
{
    public class ServerConsultingComputerBrandService : BaseService<ServerConsultingComputerBrand, int, IServerConsultingComputerBrandDao, ServerConsultingComputerBrandParameters>, IServerConsultingComputerBrandService
    {
    }
}