...
{
    public partial class SamsaraFormChooserControl : SamsaraEntityChooserControl<SamsaraForm, int, ISamsaraFormService, ISamsaraFormDao, SamsaraFormParameters>
    {
        public SamsaraFormChooserControl()
        {
            ...
            assemblyFormClassName = schemaNamespace + ".Forms.Forms.SamsaraFormForm";
            InitializeComponent();
        }
    }
}
