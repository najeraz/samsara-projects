...
{
    public partial class CustomerInfrastructureNetworkRoutersControl : ManyToOneLevel1Control<CustomerInfrastructureNetworkRouter>
    {
        #region Properties
        ...
        {
            (this.controller as CustomerInfrastructureNetworkRoutersControlController).ClearControls();
        }
